...
for _var in OLLAMA_BASE_URL OLLAMA_MODEL OLLAMA_NUM_CTX DGX_HOST \
    LLM_PROVIDER LLM_MODEL SUMMARIZE_LLM_PROVIDER SUMMARIZE_LLM_MODEL CONTENT_LLM_PROVIDER CONTENT_LLM_MODEL \
    LM_STUDIO_BASE_URL LM_STUDIO_MODEL LM_STUDIO_API_KEY \
    VLLM_BASE_URL VLLM_MODEL VLLM_API_KEY \
    CODEX_BASE_URL CODEX_MODEL CODEX_ACCESS_TOKEN CODEX_REFRESH_TOKEN CODEX_API_TIMEOUT CODEX_TOKEN_STORE_PATH \
...
class TestCronEnvInjectionViaSubprocess:
    ...
    CRON_TARGET_VARS = [
        ...
        "LLM_PROVIDER", "LLM_MODEL", "SUMMARIZE_LLM_PROVIDER", "SUMMARIZE_LLM_MODEL",
        "CONTENT_LLM_PROVIDER", "CONTENT_LLM_MODEL",
        "LM_STUDIO_BASE_URL", "LM_STUDIO_MODEL", "LM_STUDIO_API_KEY",
        "VLLM_BASE_URL", "VLLM_MODEL", "VLLM_API_KEY",
        "VOICEVOX_BASE_URL", "VOICEVOX_SPEAKER_MALE", "VOICEVOX_SPEAKER_FEMALE",
        "AIVISPEECH_BASE_URL", "AIVISPEECH_SPEAKER_MALE", "AIVISPEECH_SPEAKER_FEMALE",
