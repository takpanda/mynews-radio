            ...
            <div className="flex flex-wrap items-start justify-between gap-3 min-w-0">
              <div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  <h2 className="text-2xl font-semibold text-slate-950 break-words">
                    {latestEpisode.title || `エピソード #${latestEpisode.id}`}
                  </h2>
                  {latestEpisode.type === 'commentary' && (
                ...
                {latestEpisode.source_url && (
                  <a
                    ...
                    className="mt-2 inline-flex items-center gap-1.5 text-xs text-slate-400 hover:text-sky-600 transition-colors"
                  >
                    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" />
                      <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
                    </svg>
                    <span className="truncate max-w-[300px]">{latestEpisode.source_url}</span>
                  </a>
                )}
              </div>
